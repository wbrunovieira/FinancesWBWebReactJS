...
export function AddInvestment() {
  ...
  return (
    <div className="py-4 flex items-center justify-center">
      <Modal>
        <ModalTrigger className="bg-primary  dark:text-black text-white flex justify-center group/modal-btn">
        ...
        <ModalBody>
          <ModalContent>
            ...
            <ModalFooter className="gap-1">
              ...
              <button
                className="bg-primary  dark:bg-white dark:text-black text-sm px-2 py-1 rounded-md border border-black w-28"
